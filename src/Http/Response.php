...
class Response {
    ...
    /**
     * Set the HTTP status code for this response to `$status`.
     *
    ...
    /**
     * Get response HTTP headers as key-value or get specific key.
     *
    ...
    /**
     * Remove the given HTTP `$header` from the response.
     *
     * @param string $header
     * @return void
     */
    ...
    /**
     * Set the HTTP `"Content-Type"` header for this response.
     *
     * @param string $content
     * @return self
     */
